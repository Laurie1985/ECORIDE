                    ...
                    <form method="GET" action="/history" class="row g-3">
                        <div class="col-md-3">
                            <select name="filter_type" class="form-control">
                                ...
                                <?php if (in_array($_SESSION['user_type'] ?? 'passenger', ['passenger', 'both'])): ?>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php echo($_GET['filter_type'] ?? '') === 'driver' ? 'selected' : '' ?>>Conducteur uniquement</option>
                                <option value="passenger"<?php echo($_GET['filter_type'] ?? '') === 'passenger' ? 'selected' : '' ?>>
                                    Passager uniquement
                                </option>
                                <?php endif?>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <?php echo($_GET['filter_type'] ?? '') === 'passenger' ? 'selected' : '' ?>>Passager uniquement</option>
                                <option value="ecological"<?php echo($_GET['filter_type'] ?? '') === 'ecological' ? 'selected' : '' ?>>
                                    Ecologiques uniquement
                                </option>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php echo($_GET['filter_type'] ?? '') === 'ecological' ? 'selected' : '' ?>>Écologiques uniquement</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <select name="filter_status" class="form-control">
                                ...
                                <option value="completed"<?php echo($_GET['filter_status'] ?? '') === 'completed' ? 'selected' : '' ?>>
                                    Terminés
                                </option>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php echo($_GET['filter_status'] ?? '') === 'completed' ? 'selected' : '' ?>>Terminés</option>
                                <option value="canceled"<?php echo($_GET['filter_status'] ?? '') === 'canceled' ? 'selected' : '' ?>>
                                    Annulés
                                </option>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <?php echo($_GET['filter_status'] ?? '') === 'canceled' ? 'selected' : '' ?>>Annulés</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1">
                                        <strong>Date :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <?php echo date('d/m/Y à H:i', strtotime($carpool['departure_time'])) ?>
                                    </p>
                                    <p class="mb-1">
                                        <strong>Places :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     <?php echo $carpool['seats_available'] ?> |
                                        <strong>Prix :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <?php echo $carpool['price_per_seat'] ?> crédits/place
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1">
                                        <strong>Date :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <?php echo date('d/m/Y à H:i', strtotime($reservation['departure_time'])) ?>
                                    </p>
                                    <p class="mb-1">
                                        <strong>Conducteur :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     <?php echo htmlspecialchars($reservation['driver_username']) ?> |
                                        <strong>Places :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     <?php echo $reservation['seats_booked'] ?> |
                                        <strong>Payé :</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php echo $reservation['amount_paid'] ?> crédits
                                    </p>
                                </div>
                                <div class="col-md-3 text-center">
                                    <?php
                                ...
                                <div class="col-md-3 text-end">
                                    <a href="/reservations/<?php echo $reservation['reservation_id'] ?>" class="btn btn-sm">
                                        Voir détails
                                    </a>
                                    <?php if ($reservation['status'] === 'completed'): ?>
                                    <a href="/reviews/create/<?php echo $reservation['carpool_id'] ?>" class="btn btn-sm btn-outline-warning">
                                        Laisser un avis
                                    </a>
                                    <?php endif; ?>
                                </div>
